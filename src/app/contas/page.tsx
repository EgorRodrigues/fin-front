...
import { ArrowUpRight, Landmark, PiggyBank, Wallet, X } from "lucide-react";
...
export default function ContasPage() {
  ...
  const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    console.log("Nova conta cadastrada:", formData);
      ...
      <div className="space-y-6">
        <header className="flex flex-col gap-4 rounded-3xl border border-slate-800 bg-slate-900/80 p-6 md:flex-row md:items-center md:justify-between">
          ...
          <button
            ...
            className="inline-flex items-center justify-center rounded-full border border-cyan-400/60 bg-cyan-400/10 px-4 py-2 text-sm font-medium text-cyan-200 transition hover:bg-cyan-400/20"
          >
            Nova conta
          ...
          >
            <div className="mb-5 flex items-center justify-between">
              <div>
                ...
                <h2 className="mt-2 text-2xl font-semibold text-white">Nova conta</h2>
              </div>
              <button
                type="button"
                onClick={() => setIsOpen(false)}
